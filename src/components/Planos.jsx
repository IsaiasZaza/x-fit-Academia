...
const Planos = () => {
    ...
    return (
        <motion.section
            ref={sectionRef}
            className="bg-black py-16 lg:py-24 px-4"
            initial="hidden"
        ...
        >
            <div className="container mx-auto max-w-screen-xl">
                <motion.h2
                    className="text-3xl lg:text-4xl font-bold text-gray-50 mb-8 lg:mb-10 text-center"
                    variants={cardVariants}
                >
                    Escolha Seu Plano
                </motion.h2>
                <motion.p
                    className="text-gray-300 mb-12 text-center text-base lg:text-lg"
                    variants={cardVariants}
                >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                    ...
                    <motion.div
                        className="relative p-8 bg-gray-800 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300"
                        variants={cardVariants}
                    >
                        <div className="absolute top-0 left-0 bg-yellow-400 text-gray-800 py-1 px-4 rounded-br-lg font-bold">
                            O mais vantajoso
                        </div>
                        <h3 className="text-2xl lg:text-3xl font-semibold mb-4 text-yellow-400 text-center">Plano Anual</h3>
                        <p className="text-base lg:text-lg mb-6 text-gray-300 text-center">
                        ...
                        <ul className="mb-8 space-y-3 text-gray-300 text-center text-sm lg:text-base">
                        ...
                        <div className="flex justify-center">
                            <button className="flex items-center bg-yellow-400 text-gray-900 py-3 px-6 lg:px-8 rounded-full font-semibold hover:bg-yellow-500 transition duration-300">
                    ...
                    {/* Plano Fit */}
                    <motion.div
                        className="p-8 bg-gray-900 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300"
                        variants={cardVariants}
                    >
                        <h3 className="text-2xl lg:text-3xl font-semibold mb-4 text-yellow-400 text-center">Plano Trimenstral</h3>
                        <p className="text-base lg:text-lg mb-6 text-gray-300 text-center">
                    ...
                    <motion.div
                        ...
                        variants={cardVariants}
                    >
                        <h3 className="text-2xl lg:text-3xl font-semibold mb-4 text-yellow-400 text-center">Plano Mensal</h3>
                        <p className="text-base lg:text-lg mb-6 text-gray-300 text-center">
